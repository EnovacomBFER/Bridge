...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://enovacom.org/fhir/bridge/StructureDefinition/enovacom-patient-creation-date']) &lt;= 1">extension with URL = 'https://enovacom.org/fhir/bridge/StructureDefinition/enovacom-patient-creation-date': maximum cardinality of 'extension' is 1</sch:assert>
