# Accueil - Enovacom Bridge - Guide D'implementation Bridge v1.1.0

* [**Table of Contents**](toc.md)
* **Accueil - Enovacom Bridge**
...
```json
{
  ...
  "id" : "EnovacomBridge",
  "url" : "https://enovacom.org/fhir/bridge/ImplementationGuide/EnovacomBridge",
  "version" : "1.1.0",
  "name" : "EnovacomBridgeIG",
  "title" : "Guide D'implementation Bridge",
  "status" : "draft",
  ...
  "description" : "Guide D'implementation FHIR du projet Bridge Enovacom",
  "packageId" : "EnovacomBridge",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://enovacom.org/fhir/bridge/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "SearchParameter/appointment-actor-identifier"
      },
      "name" : "appointment-actor-identifier",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-appointment"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "SearchParameter/encounter-location-identifier"
      },
      "name" : "encounter-location-identifier",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Encounter/EncounterVisitExample"
      },
      "name" : "EncounterVisitExample",
      "description" : "Un exemple de venue ambulatoire pour un patient",
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-encounter-visit"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/appointment-enovacom-bridge"
      },
      "name" : "Enovacom Bridge Appointment Profile",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/encounter-visit-enovacom-bridge"
      },
      "name" : "Enovacom Bridge Encounter Visit Profile",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/episodeOfCare-enovacom-bridge"
      },
      "name" : "Enovacom Bridge EpisodeOfCare Profile",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/patient-enovacom-bridge"
      },
      "name" : "Enovacom Bridge Patient Profile",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/practitioner-enovacom-bridge"
      },
      "name" : "Enovacom Bridge Practitioner Profile",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-episodeofcare"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/PatientCreationDate"
      },
      "name" : "Extension Enovacom Patient Creation Date",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "SearchParameter/patient-creation-date"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Patient/1c783afa-9981-4977-be63-8859f0a8fde5"
      },
      "name" : "PatientBridgeExample",
      "description" : "Un exemple de ressource pour un patient",
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Practitioner/z65g3ad4-4512-4477-biu3-8719haf7d75"
      },
      "name" : "PractitionerBridgeExample01",
      "description" : "Un exemple de ressource pour un professionnel de santé",
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-practitioner"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Practitioner/6b70aeba-4024-4cf0-8959-2d1d6cf15597"
      },
      "name" : "PractitionerBridgeExample02",
      "description" : "Un exemple de ressource pour un professionnel de santé",
      "exampleCanonical" : "https://enovacom.org/ig/fhir/bridge/StructureDefinition/enovacom-bridge-practitioner"
    }],
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "authentification.html"
        }],
        "nameUrl" : "authentification.html",
        "title" : "Authentification mutuelle TLS",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "modeleEtab.html"
        }],
        "nameUrl" : "modeleEtab.html",
        "title" : "Modèle Etablissement",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "modeleEditeurGet.html"
        }],
        "nameUrl" : "modeleEditeurGet.html",
        "title" : "Modèle Editeur Requête FHIR",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "modeleEditeurAbo.html"
        }],
        "nameUrl" : "modeleEditeurAbo.html",
        "title" : "Modèle Editeur Abonnement",
        "generation" : "markdown"
      },
      {
        "extension" : [{
